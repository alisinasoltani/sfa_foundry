...
const Motto = () => {
    ...
    return (
    <Box className="flex lg:flex-row-reverse flex-col lg:gap-0 gap-12 lg:justify-evenly justify-center lg:items-stretch items-center py-[8rem] z-1">
        <div className="flex flex-col justify-start items-center gap-4 bg-[#ededed] py-10 px-[4rem] rounded-3xl shadow-lg" ref={ref}>
