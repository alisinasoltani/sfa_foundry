...
const Footer = () => {
  return (
    <div className="flex lg:flex-row flex-col-reverse lg:gap-0 gap-12 justify-center items-start bg-none lg:pt-[12vh] w-full xl:h-[60vh] lg:h-[70vh] h-[120vh] relative z-[100]">
            ...
            <div className="flex flex-col xl:w-[22vw] w-full justify-center items-center gap-4">
                <div className="w-full flex flex-row-reverse text-right gap-4 justify-center items-center">
                    ...
                    <div className="flex flex-col">
                        <h6 className="xl:text-[2rem] text-[1.8rem] sm:text-[1rem] sf_light">
                            صنایع ریخته گری
                        </h6>
                        <h6 className="xl:text-[1.8rem] text-[1.5rem] sm:text-[0.9rem] sf_medium">
                            سپاهان فولاد آتشگاه
                        </h6>
                    </div>
                </div>
                <h6 className="lg:w-[22rem] lg:text-[1.5rem] text-[1.2rem] sm:text-[1rem] sf_medium text-center max-w-[358px]" style={{ direction: 'rtl' }}>
                    کلیه حقوق مادی و معنوی، متعلق به سپاهان فولاد آتشگاه می باشد.
                </h6>
                <h6 className="lg:w-[22rem] text-center text-[1.2rem] sm:text-[0.9rem] sf_semi" style={{ direction: 'rtl' }}>
        ...
        <div className="flex flex-col justify-center items-end gap-4 w-full px-[2rem]">
            ...
            <div className="flex flex-row justify-end gap-2 lg:text-3xl text-2xl sm:text-[1.1rem] sf_light">
                031-42696500-4
            ...
            <div className="flex flex-col justify-center items-end gap-4">
                <div className="flex flex-row justify-end gap-2 lg:text-3xl text-xl sm:text-[1.1rem] sf_light">
                ...
                <div className="flex flex-row justify-end gap-2 lg:text-3xl text-[1.20rem] sm:text-[1.1rem] sf_light">
        ...
        <div className="flex flex-col justify-center items-end gap-4 w-full px-[2rem]">
            ...
            <h5 className="xl:text-3xl text-2xl sm:text-[1.1rem] sf_medium lg:w-[18vw] w-full" style={{ direction: 'rtl', lineHeight: '2.4rem' }}>
