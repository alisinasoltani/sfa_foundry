  ...
  return (
    <>
      <div className="w-full relative bg-[#FDFDFD] -translate-y-10 z-0 flex flex-col xl:gap-12 gap-6 pt-12 justify-center items-center lg:h-[100vh] md:h-[80vh] h-[120vh]">
          ...
          <h2 className="sf_bold lg:text-[2rem] md:text-2xl sm:text-[1.2rem] text-center z-10">
              قابل اعتماد و تایید شده
          </h2>
          <span className="sf_semi lg:text-3xl md:text-xl sm:text-[1rem] text-center lg:max-w-[45vw] xl:p-0 px-8 z-10" style={{ direction: 'rtl' }}>
